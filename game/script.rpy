...
label seven:
    ...
    "И он говорил правду: это место, эти коридоры и пустые стены больше не заточение для меня, для Генри и Скота."
    "Я уже и забыл.."
    ...
    S "Спасибо тебе, я был раз встретиться с тобой и провести это время."
